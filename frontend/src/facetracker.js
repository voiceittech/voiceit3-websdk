export default function initFaceTracker(brfv4, faceTrackerLoaded) {
  var brfv4SDK = function(brfv4SDK) {
    brfv4SDK = brfv4SDK || {};
    var Module = typeof brfv4SDK !== "undefined"
      ? brfv4SDK
      : {};
    var moduleOverrides = {};
    var key;
    ...
    function integrateWasmJS() {
      ...
      var wasmBinaryFile = "faceModel.wasm";
    ...
    function ___assert_fail(condition, filename, line, func) {
      abort("Assertion failed: " + Pointer_stringify(condition) + ", at: " + [
        filename
          ? Pointer_stringify(filename)
          : "unknown filename",
        line,
        func
          ? Pointer_stringify(func)
          : "unknown function"
      ])
    }
          ...
          ___syscall146.printChar = (function(stream, curr) {
            ...
            if (curr === 0 || curr === 10) {
              (
                stream === 1
                ? Module["print"]
                : Module["printErr"])(UTF8ArrayToString(buffer, 0));
              buffer.length = 0
            } else {
              buffer.push(curr)
            }
  ...
  (function(lib) {
    ...
    lib.BRFv4Context = function() {
      ...
      var _lib = lib;
      var retrieveFloat32ArrayAndMap = function(cFunc, mapFunc, dataLength, resultArray) {
      ...
      var mapFloat32DataToRectangleArray = function(array, data) {
        ...
        if (array.length < l) {
          i = array.length;
          while (i < l) {
            array[i] = new lib.Rectangle(0, 0, 0, 0);
            ++i
          }
        }
        i = 0;
      ...
      var _brf_c_init = _lib.cwrap("_brf_init", _void, [
        _int,
        _int,
        _int,
        _int,
      ...
      _this.getAllDetectedFaces = function(result) {
        var dataLength = _brf_c_get_allDetectedFaces_length() * 4;
        if (dataLength <= 0)
          clearArray(result);
        else
          retrieveFloat32ArrayAndMap(_brf_c_get_allDetectedFaces, mapFloat32DataToRectangleArray, dataLength, result)
      };
      ...
      _this.getMergedDetectedFaces = function(result) {
        ...
        if (dataLength <= 0)
          ...
          retrieveFloat32ArrayAndMap(_brf_c_get_mergedDetectedFaces, mapFloat32DataToRectangleArray, dataLength, result)
      };
      ...
      _this.setFaceTrackingStartParams = function(startMinFaceWidth, startMaxFaceWidth, startRotationX, startRotationY, startRotationZ) {
        _brf_c_set_faceTrackingStartParams(startMinFaceWidth, startMaxFaceWidth, startRotationX, startRotationY, startRotationZ)
      };
      ...
      var _brf_c_get_faces_length = _lib.cwrap("_brf_get_faces_length", _int, _noArgs);
      ...
      var _brf_c_get_face_triangles_length = _lib.cwrap("_brf_get_face_triangles_length", _int, [_int]);
      ...
      var _brf_c_get_face_candideVertices_length = _lib.cwrap("_brf_get_face_candideVertices_length", _int, [_int]);
      ...
      var _brf_c_get_face_translationX = _lib.cwrap("_brf_get_face_translationX", _float, [_int]);
      ...
      _this.getFaces = function(result) {
        ...
        for (var fi = 0; fi < numFaces; fi++) {
          ...
          if (dataLength <= 0)
            clearArray(face.vertices);
          else
            retrieveFloat32ArrayAndMapIndex(_brf_c_get_face_vertices, fi, mapFloat32DataToArray, dataLength, face.vertices);
          if (face.triangles.length == 0) {
            dataLength = _brf_c_get_face_triangles_length(fi);
            if (dataLength <= 0)
              clearArray(face.triangles);
            else
              retrieveUint8ArrayAndMapIndex(_brf_c_get_face_triangles, fi, mapUint8DataToArray, dataLength, face.triangles)
          }
          dataLength = _brf_c_get_face_points_length(fi) * 2;
          if (dataLength <= 0)
            clearArray(face.points);
          else
            retrieveFloat32ArrayAndMapIndex(_brf_c_get_face_points, fi, mapFloat32DataToPointArray, dataLength, face.points);
          ...
          dataLength = _brf_c_get_face_candideVertices_length(fi);
          if (dataLength <= 0)
            clearArray(face.candideVertices);
          else
            retrieveFloat32ArrayAndMapIndex(_brf_c_get_face_candideVertices, fi, mapFloat32DataToArray, dataLength, face.candideVertices);
          if (face.candideTriangles.length == 0) {
            dataLength = _brf_c_get_face_candideTriangles_length(fi);
            if (dataLength <= 0)
              clearArray(face.candideTriangles);
            else
              retrieveUint8ArrayAndMapIndex(_brf_c_get_face_candideTriangles, fi, mapUint8DataToArray, dataLength, face.candideTriangles)
          }
      ...
      var _brf_c_addOpticalFlowPoints = _lib.cwrap("_brf_addOpticalFlowPoints", _int, [_float32Array, _int]);
      ...
      _this.getOpticalFlowPoints = function(result) {
        ...
        if (dataLength <= 0)
          ...
          retrieveFloat32ArrayAndMap(_brf_c_get_opticalFlowPoints, mapFloat32DataToPointArray, dataLength, result)
      };
      var _brf_c_get_opticalFlowPointStates_length = _lib.cwrap("_brf_get_opticalFlowPointStates_length", _int, _noArgs);
      ...
      _this.getOpticalFlowPointStates = function(result) {
        ...
        if (dataLength <= 0)
          ...
          retrieveUint8ArrayAndMap(_brf_c_get_opticalFlowPointStates, mapUint8DataToBooleanArray, dataLength, result)
      };
      var _brf_c_get_opticalFlowCheckPointsValidBeforeTracking = _lib.cwrap("_brf_get_opticalFlowCheckPointsValidBeforeTracking", _boolean, _noArgs);
    ...
    lib.BRFv4ContextManager = function() {
      ...
      _this.init = function(src, imageRoi, appId) {
        if (src == null)
          throw 'faceManager init is missing the first parameter "src : BitmapData". ' + "Refer to the SDK examples for the correct usage.";
        if (imageRoi == null)
          throw 'faceManager constructor is missing the second parameter "imageRoi : Rectangle". ' + "Refer to the SDK examples for the correct usage.";
        if (appId == null || appId.length < 8)
          throw 'faceManager constructor is missing the third parameter "appId : String (length >= 8)". ' + "Refer to the SDK examples for the correct usage.";
        if (_context != null)
          _context.init(src.width, src.height, imageRoi.x, imageRoi.y, imageRoi.width, imageRoi.height, appId)
      };
      _this.update = function(imageData) {
        if (_context == null)
          throw "BRFv4Context is not available. Call init first.";
        if (imageData == null)
          throw "faceManager.update: BitmapData must NOT be null.";
      ...
      _this.setFaceTrackingStartParams = function(startMinFaceWidth, startMaxFaceWidth, startRotationX, startRotationY, startRotationZ) {
        if (_context == null)
          throw "BRFv4Context is not available. Call init first.";
        _context.setFaceTrackingStartParams(startMinFaceWidth, startMaxFaceWidth, startRotationX, startRotationY, startRotationZ)
      };
      _this.setFaceTrackingResetParams = function(resetMinFaceWidth, resetMaxFaceWidth, resetRotationX, resetRotationY, resetRotationZ) {
        if (_context == null)
          throw "BRFv4Context is not available. Call init first.";
    ...
    lib.FaceTrackerManager = lib.BRFv4ContextManager
  })(brfv4);
}
